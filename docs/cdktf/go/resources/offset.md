...
import "github.com/aws-samples/dummy/gen/providers/time/offset"
...
func newMyConvertedCode(scope construct, name *string) *myConvertedCode {
	...
	timeOffsetExample := offset.NewOffset(this, jsii.String("example"), map[string]*f64{
		"offset_days": jsii.Number(7),
	})
	cdktf.NewTerraformOutput(this, jsii.String("one_week_from_now"), &TerraformOutputConfig{
